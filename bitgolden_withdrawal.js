...
var application = 'bitgolden_withdraw';
var cooldown=60;
...
}).thenOpen("https://bitgolden.io/",function(){
...
}).thenOpen("https://bitgolden.io/account",function(){
...
/***********************************************************************/
   ...
   casper1.wait(100,function(){ //wait to start second page
    ...
    if (type=='withdrawn'){
      pusher(new_balance,'balance',start_time,generateTimestamp(),'','bitgolden');
    }
